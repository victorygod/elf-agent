 ...
 * 语言风格管理面板
 *
 * 原位置：frontend/src/components/LanguageStylesPanel.jsx
 * 迁移至：agents/elf-018/ui/LanguageStylesPanel/index.jsx
 */

import React, { useState, useEffect, useCallback } from 'react';
import * as api from '@spa/api/index.js';
import ConfirmModal from '@spa/components/ConfirmModal.jsx';
  ...
  return (
    <div style={{ padding: '8px 0' }}>
      ...
      <div style={{ fontSize: '12px', color: '#bbb', marginBottom: '8px' }}>
        default_style 恒为 render system 末尾常驻的默认风格；其余为场景风格，大纲点名后由 render 在 user 末尾加载。保存即生效。
      </div>
      ...
      {editor && (
        <div style={modalOverlay} onClick={() => setEditor(null)}>
          <div style={modalBox} onClick={(e) => e.stopPropagation()}>
            ...
            <label style={labelStyle}>description（必填）</label>
            <input
              style={inputStyle}
              value={editor.description}
              placeholder="如 战斗时紧凑凌厉"
